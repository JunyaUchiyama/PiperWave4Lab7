...
#else:
client = MongoClient("mongodb://dbadmin:PiperWave4@cluster0-shard-00-00.amdsk.mongodb.net:27017,cluster0-shard-00-01.amdsk.mongodb.net:27017,cluster0-shard-00-02.amdsk.mongodb.net:27017/?ssl=true&replicaSet=atlas-6brpz8-shard-0&authSource=admin&retryWrites=true&w=majority")
DB_NAME = "db1"  ##### Make sure this create your unique MongoDB database name######
